...
for(var S in y)for(var E=y[S].line1,C=y[S].line2,_=0;_<E.length;_++)for(var x=0;x<C.length;x++){var k=E[_].display>C[x].display?{start:C[x],end:E[_]}:{start:E[_],end:C[x]},T=k.start,M=k.end
ie(T.display,M.display,E[1-_].display)||ie(T.display,M.display,C[1-x].display)||!(0<M.display-T.display)||T.display===E[0].display&&M.display===E[1].display||T.display===C[0].display&&M.display===C[1].display||w[S][T.display]||(w[S][M.display]=!0,b[S].push({start:T,end:M}))}var R,N,O,I,P,A,j,L,B,D,U,F,q,W,H,z,V,Y,Z=[],J=r.width,X=r.height,G=(R=t,N=n,O=(0,oe.getMinBoundingRect)({width:R.width,height:R.height,top:R.top,left:R.left,rotate:R.ro}),I=(0,re.default)(O,4),P=I[0],A=I[1],j=I[2],L=I[3],B=N.width,
...
).concat(m,")")},k={transform:"scale(".concat(t/100,")")},T={width:"".concat(t,"%"),height:"".concat(t,"%")},M={width:o.width*t/100,height:o.height*t/100},R=(0,F.default)({"wait-drag":i,"is-immersive":g,"is-layer-active":s,"is-screen-expanded":g||!u})
...
!g&&O.default.createElement(L.default,{project:a,shellType:y,isLandscape:v}),c&&O.default.createElement(U.default,null)),O.default.createElement("div",{className:"no-zoom-area-wrapper",style:T},O.default.createElement("div",{className:"no-zoom-area",style:M},O.default.createElement("div",{id:"ui-layers",className:"ui-layers ".concat(s?"is-active":"")},f&&O.default.createElement(D.default,null),s&&!f&&O.default.createElement(A.default,null)),O.default.createElement("div",{id:"ui-comment-marker-panel"},
...
return document.body.appendChild(e),e},t.getDomInfo=function(){var e=document.querySelector("#canvas").getBoundingClientRect(),t=document.querySelector(".mb-viewport").getBoundingClientRect()
return{canvasTop:e.top,canvasLeft:e.left,canvasWidth:e.width,canvasHeight:e.height,screenTop:t.top,screenLeft:t.left,screenWidth:t.width,screenHeight:t.height}},t.elementsFromPoint=function(e,t){var n=2<arguments.length&&void 0!==arguments[2]?arguments[2]:document.body
...
function S(r){var T=1<arguments.length&&void 0!==arguments[1]?arguments[1]:function(){return H.u},M=2<arguments.length&&void 0!==arguments[2]?arguments[2]:H.u,R=3<arguments.length&&void 0!==arguments[3]?arguments[3]:H.u,e=4<arguments.length&&void 0!==arguments[4]?arguments[4]:{},l=5<arguments.length&&void 0!==arguments[5]?arguments[5]:{},a=6<arguments.length&&void 0!==arguments[6]?arguments[6]:0,N=7<arguments.length&&void 0!==arguments[7]?arguments[7]:"anonymous",t=arguments[8]
...
!t&&e.stack&&(t=-1!==e.stack.split("\n")[0].indexOf(e.message)?e.stack:"Error: "+e.message+"\n"+e.stack),c("error","uncaught at "+N,t||e.message||e)},A=Object(z.f)(T),j=Object.create(e)
y.cancel=H.u
...
try{e=(C?C.put:M)(_)}catch(e){if(C||x)return E(e,!0)
...
t(a)}catch(e){t(e,!0)}}(k,i):(k=Y.d.actionChannel(e))?(d=i,f=(s=k).pattern,p=s.buffer,(h=K(f)).pattern=f,void d(Object(z.d)(T,p||Z.a.fixed(),h))):(k=Y.d.flush(e))?(l=i,void k.flush(l)):(k=Y.d.cancelled(e))?void i(!!B.isCancelled):(k=Y.d.getContext(e))?void i(j[k]):(k=Y.d.setContext(e))?(c=k,u=i,H.v.assign(j,c),void u()):i(e)}function U(e,t){var n=e[H.a]
H.q.func(n)?t.cancel=n:H.q.func(e.abort)&&(t.cancel=function(){return e.abort()}),e.then(t,function(e){return t(e,!0)})}function F(e,t,n,r){S(e,T,M,R,j,l,t,n,r)}function q(e,t,n){var r=e.context,a=e.fn,o=e.args,i=e.detached,c=function(e){var t=e.context,n=e.fn,r=e.args
...
try{Object(V.c)()
var u=S(c,T,M,R,j,l,t,a.name,i?null:H.u)
...
t.default=i},DR1i:function(e,t,n){window,e.exports=function(n){var r={}
...
return this},r.prototype.listeners=function(e){return this._callbacks=this._callbacks||{},this._callbacks["$"+e]||[]},r.prototype.hasListeners=function(e){return!!this.listeners(e).length}},function(e,y,r){"use strict";(function(d){var a,e=r(33),o=r(15),f=r(39),c=r(40),p=r(41)
d&&d.ArrayBuffer&&(a=r(43))
var t="undefined"!=typeof navigator&&/Android/i.test(navigator.userAgent),n="undefined"!=typeof navigator&&/PhantomJS/i.test(navigator.userAgent),h=t||n
y.protocol=3
var m=y.packets={open:0,close:1,ping:2,pong:3,message:4,upgrade:5,noop:6},i=e(m),v={type:"error",data:"parser error"},g=r(44)
function u(e,t,n){for(var a=new Array(e.length),r=c(e.length,n),o=function(n,e,r){t(e,function(e,t){a[n]=t,r(e,a)})},i=0;i<e.length;i++)o(i,e[i],r)}y.encodePacket=function(e,t,n,r){"function"==typeof t&&(r=t,t=!1),"function"==typeof n&&(r=n,n=null)
var a,o,i,c,u,l=void 0===e.data?void 0:e.data.buffer||e.data
if(d.ArrayBuffer&&l instanceof ArrayBuffer)return c=e,u=r,y.encodeBase64Packet(c,u)
if(g&&l instanceof d.Blob)return function(e,t,n){if(!t)return y.encodeBase64Packet(e,n)
if(h)return function(e,t,n){if(!t)return y.encodeBase64Packet(e,n)
var r=new FileReader
return r.onload=function(){e.data=r.result,y.encodePacket(e,t,!0,n)},r.readAsArrayBuffer(e.data)}(e,t,n)
var r=new Uint8Array(1)
r[0]=m[e.type]
var a=new g([r.buffer,e.data])
return n(a)}(e,t,r)
if(l&&l.base64)return a=e,o=r,i="b"+y.packets[a.type]+a.data.data,o(i)
var s=m[e.type]
return void 0!==e.data&&(s+=n?p.encode(String(e.data),{strict:!1}):String(e.data)),r(""+s)},y.encodeBase64Packet=function(t,n){var r,a="b"+y.packets[t.type]
if(g&&t.data instanceof d.Blob){var o=new FileReader
...
r=String.fromCharCode.apply(null,c)}return a+=d.btoa(r),n(a)},y.decodePacket=function(e,t,n){if(void 0===e)return v
if("string"==typeof e){if("b"===e.charAt(0))return y.decodeBase64Packet(e.substr(1),t)
if(n&&!1===(e=function(e){try{e=p.decode(e,{strict:!1})}catch(e){return!1}return e}(e)))return v
var r=e.charAt(0)
return Number(r)==r&&i[r]?1<e.length?{type:i[r],data:e.substring(1)}:{type:i[r]}:v}r=new Uint8Array(e)[0]
var a=f(e,1)
return g&&"blob"===t&&(a=new g([a])),{type:i[r],data:a}},y.decodeBase64Packet=function(e,t){var n=i[e.charAt(0)]
if(!a)return{type:n,data:{base64:!0,data:e.substr(1)}}
var r=a.decode(e.substr(1))
return"blob"===t&&g&&(r=new g([r])),{type:n,data:r}},y.encodePayload=function(e,t,n){"function"==typeof t&&(n=t,t=null)
var r=o(e)
return t&&r?g&&!h?y.encodePayloadAsBlob(e,n):y.encodePayloadAsArrayBuffer(e,n):e.length?void u(e,function(e,n){y.encodePacket(e,!!r&&t,!1,function(e){var t
n(null,(t=e).length+":"+t)})},function(e,t){return n(t.join(""))}):n("0:")},y.decodePayload=function(e,t,n){if("string"!=typeof e)return y.decodePayloadAsBinary(e,t,n)
var r
if("function"==typeof t&&(n=t,t=null),""===e)return n(v,0,1)
for(var a,o,i="",c=0,u=e.length;c<u;c++){var l=e.charAt(c)
if(":"===l){if(""===i||i!=(a=Number(i)))return n(v,0,1)
if(i!=(o=e.substr(c+1,a)).length)return n(v,0,1)
if(o.length){if(r=y.decodePacket(o,t,!1),v.type===r.type&&v.data===r.data)return n(v,0,1)
if(!1===n(r,c+a,u))return}c+=a,i=""}else i+=l}return""!==i?n(v,0,1):void 0},y.encodePayloadAsArrayBuffer=function(e,r){if(!e.length)return r(new ArrayBuffer(0))
u(e,function(e,t){y.encodePacket(e,!0,!0,function(e){return t(null,e)})},function(e,t){var n=t.reduce(function(e,t){var n
...
for(i[c++]=255,r=new Uint8Array(n),a=0;a<r.length;a++)i[c++]=r[a]}),r(i.buffer)})},y.encodePayloadAsBlob=function(e,n){u(e,function(e,c){y.encodePacket(e,!0,!0,function(e){var t=new Uint8Array(1)
...
if(o[a.length]=255,g){var i=new g([t.buffer,o.buffer,e])
c(null,i)}})},function(e,t){return n(new g(t))})},y.decodePayloadAsBinary=function(e,n,r){"function"==typeof n&&(r=n,n=null)
for(var t=e,a=[];0<t.byteLength;){for(var o=new Uint8Array(t),i=0===o[0],c="",u=1;255!==o[u];u++){if(310<c.length)return r(v,0,1)
...
a.forEach(function(e,t){r(y.decodePacket(e,n,!0),t,d)})}}).call(this,r(0))},function(e,t,n){"use strict"
...
n.prototype=t.prototype,e.prototype=new n,e.prototype.constructor=e}},function(e,u,t){"use strict"
var l=t(1)("socket.io-parser"),n=t(2),o=t(28),s=t(10),r=t(11)
function a(){}u.protocol=4,u.types=["CONNECT","DISCONNECT","EVENT","ACK","ERROR","BINARY_EVENT","BINARY_ACK"],u.CONNECT=0,u.DISCONNECT=1,u.EVENT=2,u.ACK=3,u.ERROR=4,u.BINARY_EVENT=5,u.BINARY_ACK=6,u.Encoder=a,u.Decoder=d
var i=u.ERROR+'"encode error"'
function c(e){var t=""+e.type
if(u.BINARY_EVENT!==e.type&&u.BINARY_ACK!==e.type||(t+=e.attachments+"-"),e.nsp&&"/"!==e.nsp&&(t+=e.nsp+","),null!=e.id&&(t+=e.id),null!=e.data){var n=function(e){try{return JSON.stringify(e)}catch(e){return!1}}(e.data)
if(!1===n)return i
t+=n}return l("encoded %j as %s",e,t),t}function d(){this.reconstructor=null}function f(e){this.reconPack=e,this.buffers=[]}function p(e){return{type:u.ERROR,data:"parser error: "+e}}a.prototype.encode=function(e,t){var n,a
l("encoding packet %j",e),u.BINARY_EVENT===e.type||u.BINARY_ACK===e.type?(n=e,a=t,o.removeBlobs(n,function(e){var t=o.deconstructPacket(e),n=c(t.packet),r=t.buffers
r.unshift(n),a(r)})):t([c(e)])},n(d.prototype),d.prototype.add=function(e){var t
if("string"==typeof e)t=function(e){var t=0,n={type:Number(e.charAt(0))}
if(null==u.types[n.type])return p("unknown packet type "+n.type)
if(u.BINARY_EVENT===n.type||u.BINARY_ACK===n.type){for(var r="";"-"!==e.charAt(++t)&&(r+=e.charAt(t),t!=e.length););if(r!=Number(r)||"-"!==e.charAt(t))throw new Error("Illegal attachments")
n.attachments=Number(r)}if("/"===e.charAt(t+1))for(n.nsp="";++t;){var a=e.charAt(t)
if(","===a)break
if(n.nsp+=a,t===e.length)break}else n.nsp="/"
var o=e.charAt(t+1)
if(""!==o&&Number(o)==o){for(n.id="";++t;){var a=e.charAt(t)
if(null==a||Number(a)!=a){--t
break}if(n.id+=e.charAt(t),t===e.length)break}n.id=Number(n.id)}if(e.charAt(++t)){var i=function(e){try{return JSON.parse(e)}catch(e){return!1}}(e.substr(t)),c=!1!==i&&(n.type===u.ERROR||s(i))
if(!c)return p("invalid payload")
n.data=i}return l("decoded %s as %j",e,n),n}(e),u.BINARY_EVENT===t.type||u.BINARY_ACK===t.type?(this.reconstructor=new f(t),0===this.reconstructor.reconPack.attachments&&this.emit("decoded",t)):this.emit("decoded",t)
...
this.localAddress=e.localAddress}e.exports=o,a(o.prototype),o.prototype.onError=function(e,t){var n=new Error(e)
...
for(var o=a-r,i=n-t,c=Math.min(o,i),u=this.slice(r,a),l=e.slice(t,n),s=0;s<c;++s)if(u[s]!==l[s]){o=u[s],i=l[s]
...
case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return i=t,c=n,j(function(e,t){for(var n,r,a,o=[],i=0;i<e.length&&!((t-=2)<0);++i)n=e.charCodeAt(i),r=n>>8,a=n%256,o.push(a),o.push(r)
...
return t+n},d.prototype.writeUInt8=function(e,t,n){return e=+e,t|=0,n||k(this,e,t,1,255,0),d.TYPED_ARRAY_SUPPORT||(e=Math.floor(e)),this[t]=255&e,t+1},d.prototype.writeUInt16LE=function(e,t,n){return e=+e,t|=0,n||k(this,e,t,2,65535,0),d.TYPED_ARRAY_SUPPORT?(this[t]=255&e,this[t+1]=e>>>8):T(this,e,t,!0),t+2},d.prototype.writeUInt16BE=function(e,t,n){return e=+e,t|=0,n||k(this,e,t,2,65535,0),d.TYPED_ARRAY_SUPPORT?(this[t]=e>>>8,this[t+1]=255&e):T(this,e,t,!1),t+2},d.prototype.writeUInt32LE=function(e,t,n){
return e=+e,t|=0,n||k(this,e,t,4,4294967295,0),d.TYPED_ARRAY_SUPPORT?(this[t+3]=e>>>24,this[t+2]=e>>>16,this[t+1]=e>>>8,this[t]=255&e):M(this,e,t,!0),t+4},d.prototype.writeUInt32BE=function(e,t,n){return e=+e,t|=0,n||k(this,e,t,4,4294967295,0),d.TYPED_ARRAY_SUPPORT?(this[t]=e>>>24,this[t+1]=e>>>16,this[t+2]=e>>>8,this[t+3]=255&e):M(this,e,t,!1),t+4},d.prototype.writeIntLE=function(e,t,n,r){if(e=+e,t|=0,!r){var a=Math.pow(2,8*n-1)
...
return t+n},d.prototype.writeInt8=function(e,t,n){return e=+e,t|=0,n||k(this,e,t,1,127,-128),d.TYPED_ARRAY_SUPPORT||(e=Math.floor(e)),e<0&&(e=255+e+1),this[t]=255&e,t+1},d.prototype.writeInt16LE=function(e,t,n){return e=+e,t|=0,n||k(this,e,t,2,32767,-32768),d.TYPED_ARRAY_SUPPORT?(this[t]=255&e,this[t+1]=e>>>8):T(this,e,t,!0),t+2},d.prototype.writeInt16BE=function(e,t,n){return e=+e,t|=0,n||k(this,e,t,2,32767,-32768),d.TYPED_ARRAY_SUPPORT?(this[t]=e>>>8,this[t+1]=255&e):T(this,e,t,!1),t+2},
d.prototype.writeInt32LE=function(e,t,n){return e=+e,t|=0,n||k(this,e,t,4,2147483647,-2147483648),d.TYPED_ARRAY_SUPPORT?(this[t]=255&e,this[t+1]=e>>>8,this[t+2]=e>>>16,this[t+3]=e>>>24):M(this,e,t,!0),t+4},d.prototype.writeInt32BE=function(e,t,n){return e=+e,t|=0,n||k(this,e,t,4,2147483647,-2147483648),e<0&&(e=4294967295+e+1),d.TYPED_ARRAY_SUPPORT?(this[t]=e>>>24,this[t+1]=e>>>16,this[t+2]=e>>>8,this[t+3]=255&e):M(this,e,t,!1),t+4},d.prototype.writeFloatLE=function(e,t,n){return N(this,e,t,!0,n)},
...
t.byteLength=function(e){var t=f(e),n=t[0],r=t[1]
return 3*(n+r)/4-r},t.toByteArray=function(e){for(var t,n,r=f(e),a=r[0],o=r[1],i=new d(3*(a+(n=o))/4-n),c=0,u=0<o?a-4:a,l=0;l<u;l+=4)t=s[e.charCodeAt(l)]<<18|s[e.charCodeAt(l+1)]<<12|s[e.charCodeAt(l+2)]<<6|s[e.charCodeAt(l+3)],i[c++]=t>>16&255,i[c++]=t>>8&255,i[c++]=255&t
return 2===o&&(t=s[e.charCodeAt(l)]<<2|s[e.charCodeAt(l+1)]>>4,i[c++]=255&t),1===o&&(t=s[e.charCodeAt(l)]<<10|s[e.charCodeAt(l+1)]<<4|s[e.charCodeAt(l+2)]>>2,i[c++]=t>>8&255,i[c++]=255&t),i},t.fromByteArray=function(e){for(var t,n=e.length,r=n%3,a=[],o=0,i=n-r;o<i;o+=16383)a.push(u(e,o,i<o+16383?i:o+16383))
return 1===r?(t=e[n-1],a.push(c[t>>2]+c[t<<4&63]+"==")):2===r&&(t=(e[n-2]<<8)+e[n-1],a.push(c[t>>10]+c[t>>4&63]+c[t<<2&63]+"=")),a.join("")}
for(var c=[],s=[],d="undefined"!=typeof Uint8Array?Uint8Array:Array,r="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",a=0,o=r.length;a<o;++a)c[a]=r[a],s[r.charCodeAt(a)]=a
...
return o.join("")}s["-".charCodeAt(0)]=62,s["_".charCodeAt(0)]=63},function(e,t,n){"use strict"
...
return l}}()},function(u,e,t){"use strict";(function(e){var a=e.BlobBuilder||e.WebKitBlobBuilder||e.MSBlobBuilder||e.MozBlobBuilder,t=function(){try{return 2===new Blob(["hi"]).size}catch(e){return!1}}(),n=t&&function(){try{return 2===new Blob([new Uint8Array([1,2])]).size}catch(e){return!1}}(),r=a&&a.prototype.append&&a.prototype.getBlob
...
a.set(new Uint8Array(r,n.byteOffset,n.byteLength)),r=a.buffer}e[t]=r}}}function i(e,t){t=t||{}
var n=new a
o(e)
for(var r=0;r<e.length;r++)n.append(e[r])
return t.type?n.getBlob(t.type):n.getBlob()}function c(e,t){return o(e),new Blob(e,t||{})}u.exports=t?n?e.Blob:c:r?i:void 0}).call(this,t(0))},function(i,e,c){"use strict";(function(n){var r=c(14),e=c(5)
i.exports=t
var a,l=/\n/g,s=/\\n/g
...
try{this.form.submit()}catch(e){}this.iframe.attachEvent?this.iframe.onreadystatechange=function(){"complete"===n.iframe.readyState&&c()}:this.iframe.onload=c}}).call(this,c(0))},function(d,e,f){"use strict";(function(o){var t,n=f(8),i=f(3),r=f(4),e=f(5),a=f(17),c=f(1)("engine.io-client:websocket"),u=o.WebSocket||o.MozWebSocket
if("undefined"==typeof window)try{t=f(47)}catch(e){}var l=u
function s(e){e&&e.forceBase64&&(this.supportsBinary=!1),this.perMessageDeflate=e.perMessageDeflate,this.usingBrowserWebSocket=u&&!e.forceNode,this.protocols=e.protocols,this.usingBrowserWebSocket||(l=t),n.call(this,e)}l||"undefined"!=typeof window||(l=t),d.exports=s,e(s,n),s.prototype.name="websocket",s.prototype.supportsBinary=!0,s.prototype.doOpen=function(){if(this.check()){var e=this.uri(),t=this.protocols,n={agent:this.agent,perMessageDeflate:this.perMessageDeflate}
...
this.writable=!1
for(var a=e.length,t=0,n=a;t<n;t++)!function(n){i.encodePacket(n,r.supportsBinary,function(e){if(!r.usingBrowserWebSocket){var t={}
n.options&&(t.compress=n.options.compress),r.perMessageDeflate&&("string"==typeof e?o.Buffer.byteLength(e):e.length)<r.perMessageDeflate.threshold&&(t.compress=!1)}try{r.usingBrowserWebSocket?r.ws.send(e):r.ws.send(e,t)}catch(e){c("websocket closed before onclose event")}--a||(r.emit("flush"),setTimeout(function(){r.writable=!0,r.emit("drain")},0))})}(e[t])},s.prototype.onClose=function(){n.prototype.onClose.call(this)},s.prototype.doClose=function(){void 0!==this.ws&&this.ws.close()},
s.prototype.uri=function(){var e=this.query||{},t=this.secure?"wss":"ws",n=""
...
e=0==(1&Math.floor(10*t))?e-n:e+n}return 0|Math.min(e,this.max)},r.prototype.reset=function(){this.attempts=0},r.prototype.setMin=function(e){this.ms=e},r.prototype.setMax=function(e){this.max=e},r.prototype.setJitter=function(e){this.jitter=e}}])},DdHt:function(e,t,n){"use strict"
var r=n("TqRt")
...
n.d(t,"m",function(){return x}),n.d(t,"j",function(){return k}),n.d(t,"y",function(){return M}),n.d(t,"t",function(){return O}),n.d(t,"s",function(){return I}),n.d(t,"n",function(){return P}),n.d(t,"z",function(){return A}),n.d(t,"p",function(){return j}),n.d(t,"k",function(){return L}),n.d(t,"A",function(){return B}),n.d(t,"i",function(){return D})
var r=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t]
...
return function(){return++e}}var M=T(),R=function(e){throw e},N=function(e){return{value:e,done:!0}}
...
var r=n("284h"),a=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var u=a(n("o0o1")),o=a(n("yXPU")),i=a(n("lwsE")),c=a(n("W8MJ")),l=a(n("a1gu")),s=a(n("Nsbk")),d=a(n("7W2i")),f=a(n("PJYZ")),p=a(n("lSNA")),g=r(n("q1tI")),h=a(n("17x9")),y=n("DqDi"),b=a(n("i6OX")),w=a(n("4QcC")),S=a(n("Ur7v")),E=a(n("lCKy")),C=a(n("iX79")),m=n("/5+U"),_=n("1iCU"),v=n("t3Un"),x=n("Gbs1"),k=a(n("rtgd")),T=function(e){function t(e){var r
...
return n.template?v:g.default.createElement("header",{className:k.default["preview-toolbar"]},g.default.createElement("div",{className:"toolbar-left"},!p&&g.default.createElement("a",{title:I18N.back,onClick:M},g.default.createElement(b.default,{name:"back_fc",type:"dora",className:"fs-16"})),g.default.createElement("span",{className:"project-name",title:f},f)),g.default.createElement("div",{className:"toolbar-main"},v,g.default.createElement("div",{className:"toolbar-main-wrapper"},g.default.createElement(
...
break e
default:p=!0}p?z.hasOwnProperty(g)||(l=S(l=g)&&null!=s?l+'="'+M(s)+'"':""):(p=g,l=s,s=_.hasOwnProperty(p)?_[p]:null,(h="style"!==p)&&(h=null!==s?0===s.type:2<p.length&&("o"===p[0]||"O"===p[0])&&("n"===p[1]||"N"===p[1])),l=h||E(p,l,s,!1)?"":null!==s?(p=s.attributeName,3===(s=s.type)||4===s&&!0===l?p+'=""':p+'="'+M(l)+'"'):S(p)?p+'="'+M(l)+'"':""),l&&(u+=" "+l)}}i||c&&(u+=' data-reactroot=""')
var g=u
o="",O.hasOwnProperty(r)?g+="/>":(g+=">",o="</"+e.type+">")
e:{if(null!=(i=a.dangerouslySetInnerHTML)){if(null!=i.__html){i=i.__html
break e}}else if("string"==typeof(i=a.children)||"number"==typeof i){i=M(i)
...
){w("207")},renderToStaticNodeStream:function(){w("208")},version:"16.5.1"},X=J
...
p.default.createElement(g.default,{name:"tube",type:"dora",onClick:this.pickColor}))),p.default.createElement("div",{className:"param"},p.default.createElement(v.default,{className:"color-unit",menuClassName:"PreviewSubToolbarSelectMenu",value:i,optionList:T,onChange:this.updateColorUnit}),p.default.createElement(v.default,{menuClassName:"PreviewSubToolbarSelectMenu",placeholder:" ",optionList:k,value:a,onChange:this.updateLanguage}),p.default.createElement(v.default,{className:"device-unit",
...
n("mnpx")
var x=I18N.open_parenthesis+I18N.pending+I18N.close_parenthesis,k={user:0,owner:1,admin:2,editor:3,viewer:4},T=function(e){var t=e.host,n=e.userRole
return(t.isTeam()&&(0,S.PermissionCheck)("team-collaborator-update","admin",n)?["viewer","editor","admin"]:["viewer","editor"]).map(function(e){return{value:e,label:"".concat(I18N.roles[e]).concat(I18N.colon).concat(I18N.roles[e+"_desc"])}})},M=function(e,t){var n=k[e.user_id===MB.user.id?"user":e.role],r=k[t.user_id===MB.user.id?"user":t.role]
...
c=a.userRole,u=o.avatar,l=o.name,s=o.email,d=o.role,f=T({host:i,userRole:c}),p=(t=(e={host:i,collaborator:o,userRole:c}).host,n=e.collaborator,r=e.userRole,(0,S.PermissionCheck)(t.isTeam()&&"team","collaborator-update",n.role,r))
...
,v.default.createElement("ul",{className:"collaborator-list"},u.collaborators().sort(M).map(function(e){return v.default.createElement(R,{key:e.email,host:u,userRole:l,collaborator:e,onChangeRole:a.onChangeRole,onDeleteCollaborator:a.onDeleteCollaborator})})))}}]),a}(v.PureComponent)
...
return m.default.createElement("div",null,m.default.createElement("span",{className:"second-title"},a),m.default.createElement("div",{className:"panel-row"},t.length?t.map(function(e,t){var n=T(o,e,"rgba"),r=(0,y.getColorFromUnit)(n,u)
return m.default.createElement(M,{key:"".concat(t).concat(e),canDel:c,title:a,handleDelColor:i,color:r,rgbaColor:n,colorUnit:u,focusColor:l})}):m.default.createElement(R,null)))}
...
return{userPickColor:t.userPickColor,focusColor:t.focusColor}})(x),T=function(e,t,n){return(0,y.getColorFromUnit)(e?(0,y.parseSketchColor2rgba)(t):t,n)},M=function(e){var t=e.color,n=e.rgbaColor,r=e.colorUnit,a=(e.index,e.handleDelColor),o=e.canDel,i=e.title,c=e.focusColor,u=t===(0,y.getColorFromUnit)(c,r)
...
M.propTypes={color:p.default.string.isRequired,title:p.default.string,handleDelColor:p.default.func,index:p.default.number,colorUnit:p.default.string,rgbaColor:p.default.string,canDel:p.default.bool,focusColor:p.default.string}
...
function h(e){return(h="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}function c(e,t,n,r,a,o,i){try{var c=e[o](i),u=c.value}catch(e){return void n(e)}c.done?t(u):Promise.resolve(u).then(r,a)}function o(e){return function(e){if(Array.isArray(e)){for(var t=0,n=new Array(e.length);t<e.length;t++)n[t]=e[t]
return n}}(e)||function(e){if(Symbol.iterator in Object(e)||"[object Arguments]"===Object.prototype.toString.call(e))return Array.from(e)}(e)||function(){throw new TypeError("Invalid attempt to spread non-iterable instance")}()}var a=function(e,t){if(i.exec(e))return e
var n,r=(n=i.exec(t)||[""],function(e){if(Array.isArray(e))return e}(n)||function(e,t){var n=[],r=!0,a=!1,o=void 0
try{for(var i,c=e[Symbol.iterator]();!(r=(i=c.next()).done)&&(n.push(i.value),1!==n.length);r=!0);}catch(e){a=!0,o=e}finally{try{r||null==c.return||c.return()}finally{if(a)throw o}}return n}(n)||function(){throw new TypeError("Invalid attempt to destructure non-iterable instance")}())[0],a=[]
return("/"!==e[0]?o(t.split("/").slice(0,-1)).concat(o(e.split("/"))):[r.slice(0,-1)].concat(o(e.split("/").slice(1)))).forEach(function(e){return".."===e?a.pop():a.push(e)}),a.join("/")}
t.getAbsoluteUrl=a
var i=/((https?:)?\/\/)?[-\w@:%._+~#=]{2,256}\.[a-z]{2,63}(:\d{1,5})?\//,m=function(e,t){if(e.startsWith("data:"))return e
if(e.startsWith("blob:"))return(0,r.fetchDataUrlWithCache)(e)
t&&(e=a(e,t))
var n=s.exec(e)
return n&&d[n[1].toLowerCase()]?(0,r.fetchDataUrlWithCache)(e):""}
t.convertDataUrl=m
var u,l,s=/\.([0-9a-z]{3,5})(?:[?#]|$)/i,d={woff2:"font/woff2",woff:"font/woff",ttf:"font/ttf",otf:"font/otf",svg:"image/svg+xml",png:"image/png",jpg:"image/jpeg",jpeg:"image/jpeg",gif:"image/gif",bmp:"image/bmp",ico:"image/x-icon"},f=(u=regeneratorRuntime.mark(function e(t){var n,r,a,o,i,c,u,l,s,d,f,p
...
case 22:case"end":return e.stop()}},e,this)}),l=function(){var e=this,i=arguments
return new Promise(function(t,n){var r=u.apply(e,i)
function a(e){c(r,t,n,a,o,"next",e)}function o(e){c(r,t,n,a,o,"throw",e)}a(void 0)})},function(e){return l.apply(this,arguments)})
...
,U(c,r,a)),k=u&&(0,B.default)({},F[a].opacity,U(u,r,a)),T=l&&(0,B.default)({},F[a].borderRadius,U(l,r,a)),M=f&&(0,B.default)({},F[a].backgroundColor,U(f,r,a,!0)),R=p&&(0,B.default)({},F[a].color,U(p,r,a,!0)),N=h&&(0,B.default)({},F[a].fontSize,U(h,r,a)),O=m&&(0,B.default)({},F[a].fontFamily,U(m,r,a)),I=v&&(0,B.default)({},F[a].fontStyle,U(v,r,a)),P=g&&(0,B.default)({},F[a].shadows,g),A=s&&(0,B.default)({},F[a].borderWidth,U(s,r,a)),j=d&&(0,B.default)({},F[a].borderColor,U(d,r,a,!0)),L=y&&(0,B.default)({},
F[a].textAlign,y)
return Object.assign({},S,E,C,_,x,k,T,A,j,M,R,N,I,L,P,O)}
...
n("cWnZ")
var g=window.MBServer,x="file:"===location.protocol?"https://".concat(g):"https://".concat(location.host),k=[{value:"highlight",label:I18N.highlight_clickable},{value:"wechat",label:I18N.view_in_browser}],T=function(e){function t(e){var i
...
t.default=T,(0,p.default)(T,"propTypes",{dispatch:h.default.func.isRequired,isOpen:h.default.bool,onClose:h.default.func,app:h.default.object})},"SA+Z":function(e,t,n){var r=n("wTVA"),a=n("EbDI"),o=n("wkBT")
e.exports=function(e){return r(e)||a(e)||o()}},SFPg:function(e,t,n){"use strict"
var r=n("284h"),a=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var C=a(n("pVnL")),_=a(n("J4zp")),o=a(n("lwsE")),i=a(n("W8MJ")),c=a(n("a1gu")),u=a(n("Nsbk")),l=a(n("7W2i")),s=a(n("lSNA")),d=a(n("17x9")),x=r(n("q1tI")),k=a(n("vmbo")),T=n("/5+U"),f=function(e){function E(){return(0,o.default)(this,E),(0,c.default)(this,(0,u.default)(E).apply(this,arguments))}return(0,l.default)(E,e),(0,i.default)(E,[{key:"render",value:function(){var e=this.props,t=e.layer,n=e.parentRect,r=e.treeProps,a=t.width,o=t.height,i=t.top,c=t.left,u=t.z,l=t.childrenLayers
if(!1===t.v)return null
var s="layer"===t.kind?0:t.rotation||0,d=(0,T.getMinBoundingRect)({width:a,height:o,rotate:s,top:i,left:c}),f=(0,_.default)(d,4),p=f[0],h=f[1],m=f[2],v=f[3],g={top:i,left:c,width:a,height:o},y=h,b=m,w=v,S={top:(p-n.top)/n.height*100+"%",left:(y-n.left)/n.width*100+"%",width:b/n.width*100+"%",height:w/n.height*100+"%",zIndex:u||0}
...
var M=r(n("J4zp")),R=n("lMIk"),N=n("v4Lw"),o=n("FkXu"),a=n("j+XH"),O=function(e){return Object.entries(e).map(function(e){var t,n=(0,M.default)(e,2),r=n[0],a=n[1]
...
t.genSpanStyle=P
t.getHTML=function(e,t,n){for(var r=MB.currentProject.device,a="",o=t||{start:[0,0,0],end:[]},i=(0,M.default)(o.start,3),c=i[0],u=i[1],l=i[2],s=(0,M.default)(o.end,3),d=s[0],f=s[1],p=s[2],h=[],m=c;;m++){for(var v=e[m],g=[],y=m===c,b=m===d,w=m===c?u:0;;w++){var S=y&&w===u,E=b&&w===f,C=v.children[w],_=C.text.slice(S?l:0,E?p:C.text.length),x=(0,N.getEscapedText)(_)
...
if(h.push('<p style="'.concat(O(I(v)),'">').concat(k,"</p>")),n&&m!==d&&(a+="\n"),m===(b?d:e.length-1))break}var T=h.join("")
return n?{text:a,HTML:T}:T}
var A="--mb--rich-text--"
...
var s=r(n("o0o1")),a=r(n("yXPU")),l=n("CoAX"),d=n("os03"),f=n("ycqN"),p=window.MB
...
return t.map(function(e){var t=e.record,n=e.isDelete,r=t.constructor.className,a=n?"DELETE":"Asset"===r?"POST":"PUT",o="POST"===a?"/".concat(r.toLowerCase(),"s"):"/".concat(r.toLowerCase(),"s/").concat(encodeURIComponent(t.id)),i=JSON.stringify("DELETE"===a?{cid:t.cid,mtime:t.mtime}:(0,l.compressRichText)(t.toJSON())),c={className:r,cid:t.cid}
if("Panel"===r){var u=Template.find(t.template_cid)
u&&(c.template_token=u.access_token)}return{url:o,method:a,body:i,extraInfo:c}})}
...
return s.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return n=t.saveChunk,t.attempt,t.timeout,r=p.project()?p.project().template?p.project().host_cid:p.project().cid:"",a={id:p.user.id,name:p.user.name,avatar:p.user.avatar},e.next=5,p.Pusher.requestBatchSave({batchSaveQueue:n,rootProjectCid:r,fromUser:a})
case 5:case"end":return e.stop()}},e,this)}))
return function(e){return t.apply(this,arguments)}}()
...
var u=function(){var n=(0,a.default)(s.default.mark(function e(t,n){var r,a,o,i,c
...
case 6:case"end":return e.stop()}},e,this)}))
return function(e,t){return n.apply(this,arguments)}}()
t.onFallbackError=u},WF1K:function(e,t,n){"use strict"
...
return e.forEach(function(e){t=Math.min(e.top,t),n=Math.min(e.left,n),r=Math.max(e.left+e.width,r),a=Math.max(e.top+e.height,a)}),{top:t,left:n,right:r,bottom:a,width:r-n,height:a-t}}},ZY2Q:function(e,t,n){"use strict"
var r=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.reducer=function(){var e=0<arguments.length&&void 0!==arguments[0]?arguments[0]:o,t=1<arguments.length?arguments[1]:void 0,n=t.type,r=t.payload
...
var r=n("284h"),a=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var o=a(n("lwsE")),i=a(n("W8MJ")),c=a(n("a1gu")),u=a(n("Nsbk")),l=a(n("7W2i")),s=a(n("PJYZ")),d=a(n("lSNA")),v=r(n("q1tI")),f=a(n("17x9")),p=a(n("i6OX")),h=a(n("QdB0")),g=a(n("6cfl")),y=a(n("DJvY")),b=a(n("DdUa")),w=a(n("l4l/")),S=a(n("2AqR")),E=a(n("6gQ3")),C=a(n("zgSj")),_=n("oose"),x=a(n("nQhf")),k=a(n("xUDz")),T=a(n("NyBV")),M=n("1iCU"),m=a(n("XpKX")),R=a(n("UbMB")).default.bind(m.default),N=window,O=N.MB,I=N.I18N,P=new Set(["ai@mockingbot.com","ethantw@me.com"]),A=function(e){function r(e){var t;(0,
...
var u=o.toolbarActiveItem,l=o.isFullScreenMode,s=u==M.PREVIEW,d=u==M.INSPECT,f=u==M.COMMENT,p=!O.isElectron()&&!O.isHTMLZip()&&d&&c&&D(),h=!a&&s&&(P.has(r)||i),m=R({"is-offline-mode":O.isHTMLZip(),"is-uichina":O.isUIChina()||O.isForum(),"full-screen":l})
...
return!e.commentListMap[e.commentContainer.select]}),(0,d.default)((0,s.default)((0,s.default)(l)),"doReply",function(e){l.replyTextareaRef&&l.replyTextareaRef.onEditFinish(e),l.scrollRef&&M(l.scrollRef)}),(0,d.default)((0,s.default)((0,s.default)(l)),"doCreateCommentThread",function(e){e&&(l.props.dispatch({type:"entry:comment-threads:add",payload:{top:0,left:0,message:e,cancelSelect:!0}}),M(l.scrollRef))}),(0,d.default)((0,s.default)((0,s.default)(l)),"doCreateComment",function(e){
l.commentOperations.doCreateComment(e),M(l.scrollRef)}),(0,d.default)((0,s.default)((0,s.default)(l)),"renderContentReply",function(e){if(!(0,v.getProjectCommentPermission)().allowComment)return null
...
return R(n,a,o)[e]||{name:k,avatar:T}},setFocusCommentThreadCid:function(){var e=0<arguments.length&&void 0!==arguments[0]?arguments[0]:null
...
var x=function(){window.location.href="/signin?next=".concat(window.location.pathname)},k="用户已退出协作",T="/images/avatar.png",M=function(e){return e&&setTimeout(function(){return e.scrollTop=e.scrollHeight-e.offsetHeight},0)},R=(0,y.immutableTransformCache)(function(e,n,r){return e.reduce(function(e,t){return t.project_cid!==n&&t.team_cid!==r||(e[t.user_id]=t),e},{})})},dppN:function(e,t,n){},dt0z:function(e,t){e.exports=function(e){return e}},e5cp:function(e,t,n){var g=n("fmRc"),y=n("or5M"),b=n("HDyB"),w=n(
"seXi"),S=n("QqLw"),E=n("Z0cm"),C=n("DSRE"),_=n("c6wG"),x="[object Arguments]",k="[object Array]",T="[object Object]",M=Object.prototype.hasOwnProperty
e.exports=function(e,t,n,r,a,o){var i=E(e),c=E(t),u=i?k:S(e),l=c?k:S(t),s=(u=u==x?T:u)==T,d=(l=l==x?T:l)==T,f=u==l
...
return m.default.createElement(M,{key:n,src:a,name:t,currentScreenCid:u,id:n,imageSet:o,screenCid:r,requestLayer:i.requestLayer,activeLayer:i.handleActiveLayer,activeLayerId:c})}),m.default.createElement(R,{onClick:this.downloadSlice,isLoading:t,isLogin:l}))}}]),a}(m.PureComponent)
...
Object.defineProperty(t,"__esModule",{value:!0}),t.getAutoSize=void 0
var r=n("CoAX")
t.getAutoSize=function(e){return"rich_text"===e.name?{width:e.initialWidth(r.getHTML),height:e.initialHeight(r.getHTML)}:{width:e.width,height:e.height}}},hgQt:function(e,t,n){var r=n("Juji"),a=n("4sDh")
...
var T=function(e){var t=e.markIndex,n=e.information,r=e.onSelect,a=e.onDelete,o=e.permission,i=e.ifShowBtn,c=e.className,u=void 0===c?"":c,l=e.showByEnter,s=n.avatar,d=n.name
return f.default.createElement("div",{className:"".concat(w("header-container")," ").concat(u)},f.default.createElement("div",{className:w("header-info")},f.default.createElement(h.AvatarInformation,{avatar:s,name:d,index:t})),(o.update||o.delete)&&i&&l&&f.default.createElement("div",{className:w("header-tool")},o.update&&f.default.createElement(E,{onSelect:r}),o.delete&&f.default.createElement(S,{onDelete:a})))};(t.ContentHeader=T).propTypes={markIndex:p.default.number,information:p.default.object,
...
var M="collaborator"
t.COLLABORATOR=M
var R=function(e,t){return e?"guest"===t.userRole?"not_collaborator":M:"not_signin"}
t.getUserStatus=R
t.ifCanReply=function(e){var t=e.userId,n=e.currentState,r=e.permission
return R(t,n)===M&&r.create}
...
ce.width=le,ce.height=se,ce.rotation=de}var fe=(0,Ae.getBaseAttributes)(ce),pe=fe.adapterTop,he=fe.adapterLeft,me=fe.adapterWidth,ve=fe.adapterHeight,ge=fe.radius,ye=fe.opacity,be=fe.rotate,we={lineHeight:x,letterSpacing:W,unit:n,ratio:r},Se=(0,Ae.getTextAttributes)(we),Ee=Se.lineHeight,Ce=Se.letterSpacing,_e="number"==typeof N?N?"italic":"normal":void 0,xe={textStyles:B,background:T,borders:R,shadows:V,innerShadows:Z,colorUnit:v,ratio:r,unit:n},ke=(0,Ae.getCodeAttributes)(xe),Te=t.o&&100!=t.o?t.o/100:null,
Me=(0,je.transfromProptype)({attr:(0,Ie.default)({x:he,y:pe,width:me,height:ve,lineHeight:Ee,textAlign:D,opacity:Te,borderRadius:ge},ke),language:m,unit:n}),Re=ne?"ImageView":re?"TextView":"View",Ne="screen"===t.type||t.kind?t.name:O,Oe="line"===t.name
...
return n&&"pg"===t.name&&!l?null:f.default.createElement("div",{"data-cid":t.cid,"data-link_cid":s,className:o,id:"widget".concat(t.cid).concat(n),style:u},(0,p.getWidgetContent)(t,!0),f.default.createElement("div",{className:"region gesture ".concat(d)}))}}]),t}(f.PureComponent)
...
var r=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.entryMap=void 0
var a=r(n("MVZn")),l=r(n("zkrS")),o=n("2eJi"),i=(0,a.default)({},o.entryMap,{"entry:state:init":function(e){var t=e.dispatch
...
"comment"==a&&(l.default.MB.currentProject.limitation.commentable||MB.promptRenew("cant_comment",{role:l.default.MB.currentProject.owner_id!==c.id?l.default.MB.currentProject.team_cid?"team":"project":"user"})),"inspect"==a&&n({type:"SET_VISIBILITY_SCREEN",payload:{screenID:l.default.MB.currentScreen.cid}}),u!==l.default.MB.runner.mode&&(l.default.MB.runner.mode=u,setTimeout(function(){l.default.MB.runner.reload()})),n({type:"reducer:preview-toolbar:update",payload:{toolbarActiveItem:a}})}},
...
g="group",!MB.isPhantom()&&"none"!=v.ani_name&&v.v&&(g+=" animated ".concat(v.ani_name)),Link.exists(v.link_cids)&&(g+=" clickable"),v.v||(g+=" invisible"),g),x=Link.exists(u.link_cids)?u.link_cids:"",k=u.v&&Link.find(u.link_cids),T=k&&"tap"!==k.gesture?k.gesture:""
return N.default.createElement("div",{"data-cid":o,"data-link_cid":x,className:_,style:C},c.map(function(e){return N.default.createElement(M,{key:e.cid,treeData:e,offSetX:s,offSetY:d,isSnapshot:a})}),N.default.createElement("div",{className:"region gesture ".concat(T)}))}}]),M}(N.PureComponent)
...
var r=n("284h"),a=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var _=a(n("pVnL")),c=a(n("MVZn")),u=a(n("lwsE")),o=a(n("W8MJ")),l=a(n("a1gu")),s=a(n("Nsbk")),d=a(n("7W2i")),f=a(n("PJYZ")),p=a(n("lSNA")),x=r(n("q1tI")),i=a(n("17x9")),k=a(n("i6OX")),T=a(n("zkrS")),M=n("hkZD"),R=n("iETn"),N=a(n("mquD")),h=a(n("UbMB")),m=n("l0oT"),O=h.default.bind(N.default),v=function(e){function i(e){var a;(0,u.default)(this,i),a=(0,l.default)(this,(0,s.default)(i).call(this,e)),(0,p.default)((0,f.default)((0,f.default)(a)),"handleSetting",function(e){0==Number(e)&&(a.toggleEditing(),
...
a.toggleFolded=function(){return a.setState(function(e){return{isFolded:!e.isFolded}})},a.toggleReply=function(){return a.setState(function(e){return{isReply:!e.isReply}})},a.toggleEditState=function(){return a.setState(function(e){return{isEdit:!e.isEdit}})},a.toggleRenderMore=function(){return a.setState(function(e){return{renderMore:!e.renderMore}})},a.state={isFolded:o&&(0,M.checkIfMessageOverflow)(o.message)||!1,isReply:!1,renderMore:!1,isEdit:!1,showByEnter:!0},a}return(0,d.default)(i,e),(0,o.default
)(i,[{key:"componentWillReceiveProps",value:function(e){var t=e.commentList,n=t[0]&&(0,M.checkIfMessageOverflow)(t[0].message)
...
g=t[0]||null,y=g&&c.getCollaborator(g.user_id),b=t.slice(1)||[],w=2<b.length,S=t.length,E="".concat(N.default.comment," thread-initial entry ").concat(l?"":null==u?"":O(v?"comment-focus":"comment-noFocus")),C=(0,M.ifCanReply)({userId:n,currentState:r,permission:o})
return 0==S?null:x.default.createElement("div",{ref:this.setCommentRef,className:E,onMouseEnter:this.toggleSelect,onMouseLeave:this.cancelSelect},x.default.createElement("div",null,x.default.createElement(M.ContentHeader,{markIndex:i,onSelect:this.handleSetting,onDelete:this.doDeleteThread,permission:o,information:y,ifShowBtn:!h,showByEnter:m}),x.default.createElement("div",{className:O("container-main")},g&&x.default.createElement(M.ContentMessage,{permission:o,comment:g,isFolded:p,isEdit:h,
toggleEdit:this.toggleEditing,getValue:this.getCommentMessage,setEditableSpanComponent:this.setEditableSpanComponent,onValueChange:this.doUpdateComment}),!this.state.isEdit&&x.default.createElement("div",{className:"".concat(O("container-bottom"))},g&&x.default.createElement("div",{className:N.default.time},T.default.L10N.parseTimeAgo(1e3*g.updated_at)),C&&x.default.createElement("div",{className:O("reply-sort"),onClick:this.toggleReply},x.default.createElement(k.default,{type:"dora",name:"reply",
className:O("btn-reply")}),d?T.default.I18N.preview.comment.cancel_reply:T.default.I18N.preview.comment.comment_create)))),x.default.createElement(M.ReplyDropdown,{isReply:d,doReply:this.doReply,onValueChange:this.doCreateComment,setReplyTextareaRef:this.setReplyTextareaRef}),w?x.default.createElement(R.CommentReplyEntry,(0,_.default)({doCreateComment:this.doCreateComment,replyList:b.slice(0,2)},this.props)):x.default.createElement(R.CommentReplyEntry,(0,_.default)({doCreateComment:this.doCreateComment,
...
var m=r(n("RIqP")),a=r(n("wig9")),o=r(n("7tbW")),k=n("/5+U"),T=n("XrEr")
...
t=y&&(0,T.getNormalRgbaColor)(y),n=(0,k.adapterScreen)(b,v,m),r=w}if(d.length){var S=d[0],E=S.position,C=void 0===E?"inside":E,_=S.color,x=S.thickness
a=(0,k.adapterScreen)(x,v,m),i=C,_&&(o=(0,T.getNormalRgbaColor)(_))}return f.length&&(c=(0,T.getNormalRgbaColor)(f[0].value)),p.length&&(u=M(p,m,v)),h.length&&(l=M(h,m,v,!0),u="".concat(u,", ").concat(l)),{fontFamily:r,fontSize:n,color:t,borderWidth:a,borderColor:o,borderPosition:i,backgroundColor:c,boxShadow:u}}
t.reduceTextLayer=function(e){if(0===e.length)return[]
var t=e.reduce(function(e,t){var n=t.font
return e.concat(n)},[])
return(0,m.default)(new Set(t))}
var M=function(e,g,y){var b=3<arguments.length&&void 0!==arguments[3]&&arguments[3],w=e.length
...
d=(0,k.adapterScreen)(d,y,g),r=(0,T.getNormalRgbaColor)(r)
...
return l.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:if(a=d.getCurrentScreen(),"update"!==t){e.next=31
break}if(o=p.find(n.cid)){e.next=26
break}return e.prev=4,e.next=7,(0,s.requestJSON)("/app/".concat(r.template_token,".json"))
case 7:if(i=e.sent,Template.refresh([i.project]),f.refresh(i.screens),m.refreshWidgetAfterDecompress(i.widgets),g.refresh(i.links),d.Pusher.enableSocketChannel(i.project.cid),(c=new p).load(n),c.lsave(!1),d.renderTemplateList(),a===c.screen_cid)return e.abrupt("return",ScreenManager.updateWidgetList())
e.next=19
break
case 19:e.next=24
break
case 21:e.prev=21,e.t0=e.catch(4),console.warn(e.t0)
case 24:e.next=29
break
case 26:if(o.refresh(n),a===o.screen_cid)return e.abrupt("return",ScreenManager.updateWidgetList())
e.next=29
break
case 29:e.next=42
break
case 31:if("destroy"!==t){e.next=42
break}if(u=p.find(n.cid)){e.next=35
break}return e.abrupt("return")
case 35:if(a===u.screen_cid)return PanelManager.remove(u.cid,!1),d.action("selection:unselect:items",{cids:[u.cid]}),e.abrupt("return",ScreenManager.updateWidgetList())
e.next=41
break
case 41:return e.abrupt("return",u.ldestroy(!1))
case 42:case"end":return e.stop()}},e,this,[[4,21]])}))
...
var i,l=(i=r(regeneratorRuntime.mark(function e(t){var n,r,a,o,i,c,u,l,s,d,f,p,h,m,v,g,y,b,w,S,E,C,_,x,k,T,M
...
var u=!1
o.forEach(function(e){i&&e!==i?e.isIgnore=!0:c&&e!==c?e.isIgnore=!0:(e.isIgnore=u,u=!0)})}),T=function(){return{htmlString:b,cssString:w,domString:S,svgString:E,svgDataUrl:C,imageElement:_,canvasElement:x,pngDataUrl:k}},e.prev=46,e.t4=I.prepareHTMLString,e.next=50,(0,N.convertFragListWithUrlMap)(v)
...
case 69:M=e.sent,_=M.imageElement,x=M.canvasElement,k=M.pngDataUrl
case 73:e.next=78
break
...
n.d(t,"i",function(){return C}),n.d(t,"s",function(){return _}),n.d(t,"v",function(){return x}),n.d(t,"n",function(){return k}),n.d(t,"b",function(){return T}),n.d(t,"o",function(){return M}),n.d(t,"e",function(){return N}),n.d(t,"c",function(){return O}),n.d(t,"h",function(){return I}),n.d(t,"k",function(){return P}),n.d(t,"r",function(){return A}),n.d(t,"m",function(){return j}),n.d(t,"f",function(){return L}),n.d(t,"p",function(){return B}),n.d(t,"a",function(){return D}),n.d(t,"g",function(){return U}),
...
function k(e,t){return 1<arguments.length?(Object(i.h)(e,i.q.notUndef,"put(channel, action): argument channel is undefined"),Object(i.h)(e,i.q.channel,"put(channel, action): argument "+e+" is not a valid channel"),Object(i.h)(t,i.q.notUndef,"put(channel, action): argument action is undefined")):(Object(i.h)(e,i.q.notUndef,"put(action): argument action is undefined"),t=e,e=null),E(o,{channel:e,action:t})}function T(e){return E(u,e)}function M(e){return E(l,e)}function R(e,t,n){Object(i.h)(t,i.q.notUndef,
...
if(1<t.length)return T(t.map(function(e){return j(e)}))
var r=t[0]
...
if(1<t.length)return T(t.map(function(e){return L(e)}))
var r=t[0]
...
case"mselect":return m.default.createElement(T,{widget:e})
...
case"switch":case"ios_switch":return m.default.createElement(J,{widget:e})
case"android_switch":return m.default.createElement(X,{widget:e})
...
return m.default.createElement("input",{type:"radio",name:e.gid,checked:e.checked})}}]),t}(b),T=function(e){function t(){return(0,c.default)(this,t),(0,f.default)(this,(0,p.default)(t).apply(this,arguments))}return(0,h.default)(t,e),(0,u.default)(t,[{key:"render",value:function(){var e=this.props.widget
return m.default.createElement("select",null,e.text.split(/\n/).map(function(e,t){return m.default.createElement("option",{key:e+t},e)}))}}]),t}(b),M=function(e){function t(){return(0,c.default)(this,t),(0,f.default)(this,(0,p.default)(t).apply(this,arguments))}return(0,h.default)(t,e),(0,u.default)(t,[{key:"render",value:function(){var e=this.props.widget
...
return t.defaultView||t.parentWindow||o}var I="ontouchstart"in o,P=R(o,"PointerEvent")!==m,A=I&&/mobile|tablet|ip(ad|hone|od)|android/i.test(navigator.userAgent),j="touch",L=25,B=1,D=4,U=8,F=1,q=2,W=4,H=8,z=16,V=q|W,Y=H|z,Z=V|Y,J=["x","y"],X=["clientX","clientY"]
...
if(t===B&&(this.started=!0),this.started){var n=function(e,t){var n=T(e.touches),r=T(e.changedTouches)
t&(D|U)&&(n=M(n.concat(r),"identifier",!0))
...
function ge(){this.evTarget=ve,this.targetIds={},G.apply(this,arguments)}h(ge,G,{handler:function(e){var t=me[e.type],n=function(e,t){var n=T(e.touches),r=this.targetIds
if(t&(2|B)&&1===n.length)return r[n[0].identifier]=!0,[n,n]
var a,o,i=T(e.changedTouches),c=[],u=this.target
...
return c.length?[M(o.concat(c),"identifier",!0),c]:void 0}.call(this,e,t)
...
var Se=R(t.style,"touchAction"),Ee=Se!==m,Ce="manipulation",_e="none",xe="pan-x",ke="pan-y",Te=function(){if(!Ee)return!1
...
function Me(e,t){this.manager=e,this.set(t)}Me.prototype={set:function(e){"compute"==e&&(e=this.compute()),Ee&&this.manager.element.style&&Te[e]&&(this.manager.element.style[Se]=e),this.actions=e.toLowerCase().trim()},update:function(){this.set(this.manager.options.touchAction)},compute:function(){var t=[]
...
else{var r=this.actions,a=_(r,_e)&&!Te.none,o=_(r,ke)&&!Te[ke],i=_(r,xe)&&!Te[xe]
...
for(var i=0;i<o.length;)o[i](t),i++}},destroy:function(){this.element&&He(this,!1),this.handlers={},this.session={},this.input.destroy(),this.element=null}},i(qe,{INPUT_START:B,INPUT_MOVE:2,INPUT_END:D,INPUT_CANCEL:U,STATE_POSSIBLE:Re,STATE_BEGAN:2,STATE_CHANGED:4,STATE_ENDED:8,STATE_RECOGNIZED:8,STATE_CANCELLED:16,STATE_FAILED:32,DIRECTION_NONE:F,DIRECTION_LEFT:q,DIRECTION_RIGHT:W,DIRECTION_UP:H,DIRECTION_DOWN:z,DIRECTION_HORIZONTAL:V,DIRECTION_VERTICAL:Y,DIRECTION_ALL:Z,Manager:We,Input:G,TouchAction:Me,
...
var _=(0,g.connect)(function(e){var t=e.container,n=t.layers,r=n.activeLayerID,a=n.visibilityScreenID,o=n.resourceByScreen,i=t.previewSetting,c=e.model,u=c.current,l=u.screenCid,s=u.projectCid,d=c.projects,f=i.isSelectLayer,p=k(d,s).device,h=T(f,o,a,r),m=x(o,a,p)
...
r=l.screenColor,i=l.globalText,a=c.documentColor,o=c.globalColor}return{screenColor:r,documentColor:a,globalColor:o,globalText:i}}),k=(0,S.immutableTransformCache)(function(e,t){return e.find(function(e){return e.cid===t})}),T=(0,S.immutableTransformCache)(function(e,t,n,r){var a=t[n]
...
var r=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var a=r(n("yTJ9")),o=r(n("knB1")),i=r(n("QkVN")),c=window,u=c.confirm,l=c.alert,s=c.MB,d=c.MBLocale,f=c.I18N,p=c.Team,h=c.Project,m=c.Combo,v=c.Template,g=c.Screen,y=c.Screenstate,b=c.Widget,w=c.Widgetstate,S=c.Panel,E=c.Panelstate,C=c.Link,_=c.Collaborator,x=c.Comment,k=c.CommentThread,T=c.Asset
"zh-CN"===d&&(0,i.default)(a.default.settings.strings,o.default)
var M={MBLocale:d,parseTimeAgo:function(e){return(0,a.default)(e)}},R={Team:p,Project:h,Combo:m,Template:v,Screen:g,Screenstate:y,Widget:b,Widgetstate:w,Panel:S,Panelstate:E,Link:C,Collaborator:_,Comment:x,CommentThread:k,Asset:T,requestCid:function(){return(0<arguments.length&&void 0!==arguments[0]?arguments[0]:"")+Math.uuid(10,16)+Date.now()},queueSave:function(){return s.AutoSaver&&s.AutoSaver.triggerSave()}},N={Global:window,Storage:s.localStorageDelegate,confirm:function(){return u.apply(void 0,
arguments)},alert:function(){return l.apply(void 0,arguments)},MB:s,I18N:f,L10N:M,SpineModel:R}
t.default=N}}])

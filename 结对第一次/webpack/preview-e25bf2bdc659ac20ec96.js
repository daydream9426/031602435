(window.webpackJsonp=window.webpackJsonp||[]).push([[6],{190:function(e,t,a){a("55Il"),e.exports=a("Z3xQ")},"20hc":function(e,t,a){"use strict"
var n=a("TqRt"),u=n(a("o0o1")),r=n(a("yXPU")),d=n(a("q1tI")),p=n(a("i8i4")),l=a("XkTy"),s=a("tajm"),f=n(a("NkXT")),o=window,m=o.$,w=o.MB,c=o.MBLocale,h=o.md5,i=o.SharingRunner,g=w.localStorageDelegate,v=function(){return!!window.MBData},b=/\/embed\b/.test(location.pathname)
w.f.inSharing=!0
var k=function(e,t){return t||new URLSearchParams(location.search).get("password")||g.getItem("".concat(e,"_pwd"))}
w.load=function(){var t=(0,r.default)(u.default.mark(function e(t){var a,n,r,s,o,c,i,l
return u.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:if(a=t.token,n=t.isPasswordRequired,r=t.encryptedPassword,s=t.installerProject,w.webpackInterface.renderPreviewAlert(),o=k(a,r),c=!w.isStandAlone()&&!w.isInApp&&w.isMobile()&&!v()&&!b,w.supportedBrowser()){e.next=8
...
case 19:return l=e.sent,e.abrupt("return",v()?y(l):l?E(l):null)
...
return u.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:if(a=t.token,n=t.encryptedPassword,r=t.shouldGetData,s=void 0===r||r,o=window.MBData,!v()){e.next=6
...
case 14:return i="/app/".concat(a,".json?").concat((new Date).valueOf()).concat(n?"&password=".concat(n):""),e.abrupt("return",M(i))
...
return function(e){return t.apply(this,arguments)}}(),M=function(e){return new Promise(function(t,n){return m.getJSON(e,function(e){return t(e)}).fail(function(e,t,a){return n(a)})})},E=function(e){m(".indicator").css("height","100%"),setTimeout(function(){return x(e)},300)},y=function(e){w.staticMap=function(){return"images/workspace/staticmap_".concat(c,".png")},e.project.splash="images/splash.png",e.screens.forEach(function(e){e.bgimage&&(e.bgimage=e.bgimage.replace(/^.+uploads.*?\//,""))}),
e.widgets.forEach(function(e){e.image&&(e.image=e.image.replace(/^.+uploads.*?\//,""))}),e.widgetstates.forEach(function(e){e.image&&(e.image=e.image.replace(/^.+uploads.*?\//,""))}),m(".indicator").css("height","100%"),setTimeout(function(){return x(e)},300)},x=function(e){var t=e.project.template?new Template:e.project.combo?new Combo:new Project
...
s.patchGlobalAutoSaverPusher)(),(new Image).src=w.staticMap(),m("title").html(t.name),m("#loading").hide(),!t.validated&&w.isMobile()&&(0,l.alertAsync)({title:I18N.reminder,desc:I18N.fraud_warning,confirmText:I18N.fraud_confirm,isHTML:!0}),w.checkFA(function(){m(".box").hide(),w.currentProject=t,w.webpackInterface.init(),w.Pusher&&w.user.id&&"guest"!==w.webpackInterface.store.getState().model.current.userRole&&w.Pusher.enableSocketChannel(t.cid),w.runner=new i(t),w.runner.render()})}},KUpD:function(e,t,a){
e.exports={"install-page-wrapper":"_2145f6w_gvAx5jbCLSvNm1","install-page":"_1ucR52TRm2uhcZJhUjsxqG"}},NkXT:function(e,t,a){"use strict"
var n=a("284h"),r=a("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var o=r(a("lwsE")),s=r(a("W8MJ")),c=r(a("a1gu")),i=r(a("Nsbk")),l=r(a("7W2i")),u=r(a("PJYZ")),d=r(a("lSNA")),p=r(a("o0o1")),f=r(a("yXPU")),m=a("17x9"),w=n(a("q1tI")),h=r(a("PeD6")),g=r(a("KUpD")),v=r(a("UbMB")),b=a("t3Un"),k=v.default.bind(g.default),P=function(){var t=(0,f.default)(p.default.mark(function e(t){var a,n,r
...
return function(e){return t.apply(this,arguments)}}(),N=function(t){return new Promise(function(e){return setTimeout(e,t)})},M=function(e){function t(){var s
...
t.default=M,(0,d.default)(M,"propTypes",{project:m.PropTypes.object,loadProject:m.PropTypes.func,encryptedPassword:m.PropTypes.string})},PeD6:function(e,t,a){"use strict"
var n=a("284h"),r=a("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var o=r(a("lwsE")),c=r(a("W8MJ")),i=r(a("a1gu")),l=r(a("Nsbk")),u=r(a("7W2i")),d=r(a("PJYZ")),p=r(a("lSNA")),s=a("17x9"),f=n(a("q1tI")),m=r(a("ldhK")),w="/images/sharing/wechat_".concat(window.MBLocale,".png"),h="/images/sharing/ios_".concat(window.MBLocale,".png"),g=function(e){function s(){var e,t;(0,o.default)(this,s)
...
className:"tip"},I18N.building_apk),f.default.createElement("div",{className:"spinner"}))))}}]),s}(f.PureComponent);(t.default=g).propTypes={show:s.PropTypes.bool,onClose:s.PropTypes.func}},Z3xQ:function(e,t,a){"use strict"
